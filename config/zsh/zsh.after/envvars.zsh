...
typeset -U path
path=(~/.local/bin /opt/homebrew/opt/python@3.9/libexec/bin "${homebrew_dir}/opt/ruby/bin" "${homebrew_dir}/lib/ruby/gems/3.0.0/bin" "$path[@]" /usr/local/sbin /usr/local/bin)
